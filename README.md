...
```
    ...
    --2020-03-11 17:27:29--  http://ai.stanford.edu/~amaas/data/sentiment/aclImdb_v1.tar.gz
    ...
    2020-03-11 17:27:35 (15.9 MB/s) - ‘../data/aclImdb_v1.tar.gz’ saved [84125825/84125825]
...
**Answer:**
The method also converts all words to lower case and removes all punctuations and removes some words which are not important for the analysis.
...
```
    ...
    array([ 389,   11, 4674, 2992,   37,  148, 3085,  259,   32,  193, 2644,
           1820, 1250,   13,  117,  222,  190, 2811, 1749,  275,  410,  193,
             32,   17,   97,    8,  419,   23,  996,  204,  163,    2,  313,
            360,  240,    4,    0,    0,    0,    0,    0,    0,    0,    0,
...
```
    ...
    Epoch: 1, BCELoss: 0.6982771873474121
    Epoch: 2, BCELoss: 0.6860639572143554
    Epoch: 3, BCELoss: 0.6768688201904297
    Epoch: 4, BCELoss: 0.6684441804885864
    Epoch: 5, BCELoss: 0.6594980001449585
...
```
    ...
    2020-03-11 18:58:05 Starting - Starting the training job...
    2020-03-11 18:58:07 Starting - Launching requested ML instances...
    2020-03-11 18:59:01 Starting - Preparing the instances for training......
    2020-03-11 19:00:04 Downloading - Downloading input data...
    2020-03-11 19:00:24 Training - Training image download completed. Training in progress.[34mbash: cannot set terminal process group (-1): Inappropriate ioctl for device[0m
    [34mbash: no job control in this shell[0m
    [34m2020-03-11 19:00:25,652 sagemaker-containers INFO     Imported framework sagemaker_pytorch_container.training[0m
    [34m2020-03-11 19:00:25,654 sagemaker-containers INFO     No GPUs detected (normal if no gpus installed)[0m
    [34m2020-03-11 19:00:25,668 sagemaker_pytorch_container.training INFO     Block until all host DNS lookups succeed.[0m
    [34m2020-03-11 19:00:27,092 sagemaker_pytorch_container.training INFO     Invoking user training script.[0m
    [34m2020-03-11 19:00:27,337 sagemaker-containers INFO     Module train does not provide a setup.py. [0m
    [34mGenerating setup.py[0m
    [34m2020-03-11 19:00:27,337 sagemaker-containers INFO     Generating setup.cfg[0m
    [34m2020-03-11 19:00:27,338 sagemaker-containers INFO     Generating MANIFEST.in[0m
    [34m2020-03-11 19:00:27,338 sagemaker-containers INFO     Installing module with the following command:[0m
    ...
    [34m  Running setup.py bdist_wheel for nltk: finished with status 'done'
      ...
      Stored in directory: /tmp/pip-ephem-wheel-cache-2sen1jbr/wheels/35/24/16/37574d11bf9bde50616c67372a334f94fa8356bc7164af8ca3[0m
    ...
    [34m2020-03-11 19:00:39,329 sagemaker-containers INFO     No GPUs detected (normal if no gpus installed)[0m
    [34m2020-03-11 19:00:39,343 sagemaker-containers INFO     Invoking user script
    [0m
    [34mTraining Env:
    [0m
    [34m{
        ...
        "module_dir": "s3://sagemaker-us-east-2-672088940799/sagemaker-pytorch-2020-03-11-18-58-05-050/source/sourcedir.tar.gz",
        ...
        "job_name": "sagemaker-pytorch-2020-03-11-18-58-05-050",
        "hosts": [
            "algo-1"
        ][0m
    [34m}
    ...
    [34mSM_MODULE_DIR=s3://sagemaker-us-east-2-672088940799/sagemaker-pytorch-2020-03-11-18-58-05-050/source/sourcedir.tar.gz[0m
    ...
    [34mSM_TRAINING_ENV={"additional_framework_parameters":{},"channel_input_dirs":{"training":"/opt/ml/input/data/training"},"current_host":"algo-1","framework_module":"sagemaker_pytorch_container.training:main","hosts":["algo-1"],"hyperparameters":{"epochs":10,"hidden_dim":200},"input_config_dir":"/opt/ml/input/config","input_data_config":{"training":{"RecordWrapperType":"None","S3DistributionType":"FullyReplicated","TrainingInputMode":"File"}},"input_dir":"/opt/ml/input","job_name":"sagemaker-pytorch-2020-03-11-18-58-05-050","log_level":20,"model_dir":"/opt/ml/model","module_dir":"s3://sagemaker-us-east-2-672088940799/sagemaker-pytorch-2020-03-11-18-58-05-050/source/sourcedir.tar.gz","module_name":"train","network_interface_name":"eth0","num_cpus":4,"num_gpus":0,"output_data_dir":"/opt/ml/output/data","output_dir":"/opt/ml/output","output_intermediate_dir":"/opt/ml/output/intermediate","resource_config":{"current_host":"algo-1","hosts":["algo-1"],"network_interface_name":"eth0"},"user_entry_point":"train.py"}[0m
    ...
    [34mEpoch: 1, BCELoss: 0.6763027115743987[0m
    [34mEpoch: 2, BCELoss: 0.5941263753540662[0m
    [34mEpoch: 3, BCELoss: 0.563140617949622[0m
    [34mEpoch: 4, BCELoss: 0.46023645023910364[0m
    [34mEpoch: 5, BCELoss: 0.4014715613151083[0m
    [34mEpoch: 6, BCELoss: 0.3896703647107494[0m
    [34mEpoch: 7, BCELoss: 0.39031145159079106[0m
    [34mEpoch: 8, BCELoss: 0.33265760115214754[0m
    [34mEpoch: 9, BCELoss: 0.3147005682088891[0m
    [34mEpoch: 10, BCELoss: 0.29101709382874624[0m
    [34m2020-03-11 20:40:39,169 sagemaker-containers INFO     Reporting training SUCCESS[0m
    
    2020-03-11 20:41:38 Uploading - Uploading generated training model
    2020-03-11 20:41:45 Completed - Training job completed
    Training seconds: 6101
    Billable seconds: 6101
...
**Answer:**
This model accuracy is similar to the XGBoost mode created earlier.
though a RNN must be better for sentiment analysis because it will take into account not only the presence of words but also the order in which they appear.
        ...
        for f in files:
            with open(f) as review:
                ...
                if sentiment == 'pos':
                    ...
                    ground.append(0)
                # Read in the review and convert to 'utf-8' for transmission via HTTPlhll
...
```
    ...
    'sagemaker-pytorch-2020-03-11-21-32-45-634'
